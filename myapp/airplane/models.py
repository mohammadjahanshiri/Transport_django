...
class Flight(models.Model):
    ...
    passengers = models.ManyToManyField(Passenger ,  related_name="flight" , verbose_name="مسافر های پرواز" , blank=True)
    attendant = models.ManyToManyField(Attendant , related_name="flight" , verbose_name="مهماندار های پرواز" , blank=True)
